...
import (
	...
	"github.com/LMF709268224/titan-vps/lib/trxbridge/util"
...
// GetConstantResultOfContract GetConstantResultOfContract
...
func (g *GrpcClient) FreezeBalance(ownerKey *ecdsa.PrivateKey,
	frozenBalance, frozenDuration int64,
) (*api.Return, error) {
...
// CreateAssetIssue CreateAssetIssue
func (g *GrpcClient) CreateAssetIssue(ownerKey *ecdsa.PrivateKey,
	...
	icoNum, voteScore int32, frozenSupply map[string]string,
) (*api.Return, error) {
...
// UpdateAssetIssue UpdateAssetIssue
