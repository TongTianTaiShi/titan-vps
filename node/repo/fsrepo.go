...
import (
	...
	"github.com/LMF709268224/titan-vps/node/fsutil"
...
func (transaction) Config() interface{} {
	return config.DefaultTransactionCfg()
}

func (transaction) APIFlags() []string {
	return []string{"transaction-api-url"}
}

func (transaction) RepoFlags() []string {
	return []string{"transaction-repo"}
}

func (transaction) APIInfoEnvVars() (primary string, fallbacks []string, deprecated []string) {
